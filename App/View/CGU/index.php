...
<div id="body">
  ...
  <div class="page">
      ...
      <div class="cgu">
          ...
          <p>L’utilisation du Site est soumise au respect des présentes CGU. Tout Utilisateur reconnaît accepter les CGU, sans réserve, du seul fait de son utilisation du Site.
          ...
          <p><span>2.1.</span> Le Site et chacun des éléments qui le composent et notamment, mais non exclusivement, textes, marques, logos, sons, musiques, mises en page, supports, icônes, et plus généralement, tous éléments visuels ou sonores (Ci-après les « Éléments de propriété intellectuelle »), sont protégés par des droits de propriété intellectuelle dont la Société est titulaire ou dont un ou plusieurs tiers ont cédé à la Société le droit d’usage.
              ...
              <span>2.4.</span> Toute introduction de données sur le Site, par quelque procédé que ce soit, qui modifierait ou qui serait susceptible de modifier le contenu ou l’apparence des données, la présentation ou de l'organisation du Site ou encore des œuvres figurant sur le Site est strictement interdite.</p>
          ...
          <h3>ARTICLE 4 – PROTECTION DES DONÉES A CARACTÈRE PERSONNEL ET COOKIES</h3>
          <p><span>4.1.</span> L’Utilisateur est invité à consulter la page suivante : xxxxxxxxxxcookies.com</p>
          ...
          <p>5.1.6. L’Utilisateur s’engage à respecter l’intégrité du Site. Il s’interdit d'entraver ou forcer le fonctionnement du Site, de modifier, d'altérer ou de supprimer frauduleusement les contenus accessibles via le Site et d'introduire frauduleusement des données sur le Site.</p>
