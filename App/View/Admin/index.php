...
<div id="body">
	...
	<div class="users">
		...
		<div class="action">
			<a href="/admin/add-user"><button class="btn add" type="submit" name="button">Ajouter</button></a>
	...
	<div class="users">
		...
		<div class="action">
			<a href="/admin/edit-faq"><button class="btn edit" type="submit" name="button">Modifier</button></a>
			<form class="search-bar" method="post">
          <button class="sub-none" type="submit"><i class="fas fa-search fa-2x icon"></i></button>
          <input type="text" autocomplete="off" class="search-input" placeholder="Rechercher des utilisateurs...">
      </form>
	...
	<div class="users">
		...
		<div class="action">
			<a href="/admin/edit-faq"><button class="btn add" type="submit" name="button">Ajouter une catégorie</button></a>
