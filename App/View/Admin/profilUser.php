...
<div id="body">
  ...
  <div class="form-profil box">
    ...
    <div class="top-btn">
      <button type="submit" name="delete" class="btn delete"><i class="far fa-user-minus"></i>Supprimer</button>
      <button type="submit" name="ban" class="btn ban"><i class="far fa-user-slash"></i>Bannir</button>
    </div>
      <div class="">
        ...
        <div class="fields">
          ...
          <div class="right">
            ...
            <?php if($profil['status']==2): ?>
            <label><i class="far fa-user-tag"></i>Institution référente</label>
